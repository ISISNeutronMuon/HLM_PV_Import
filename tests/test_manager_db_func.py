...
from service_manager import db_func
...
class TestManagerDBFunc(unittest.TestCase):
    ...
    @mock.patch("service_manager.db_func.database", new=mock_database.database)
    def test_db_connect_WHEN_mock_database_THEN_raise_exception(self):
        db_func.db_connect()
        mock_database.database.close()

    @mock.patch("service_manager.db_func.database.is_connection_usable")
